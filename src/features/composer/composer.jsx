...
/** @param {{ value: string, running: boolean, disabled?: boolean, commands?: Array<any>, models: Array<any>, model: any, thinkingLevel?: string, thinkingLevels?: string[], onChange: (value: string) => void, onSend: () => void, onStop: () => void, onModelChange: (model: any) => void, onThinkingChange: (level: string) => void }} props */
export function Composer({ value, running, disabled, commands = [], models, model, thinkingLevel = "medium", thinkingLevels = DEFAULT_THINKING, onChange, onSend, onStop, onModelChange, onThinkingChange }) {
