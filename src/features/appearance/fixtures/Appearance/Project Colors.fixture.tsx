...
import { PROJECT_COLORS, projectColorVariables } from "@/features/appearance/project-color";
import { Button } from "@/shared/ui/button";
import { Icon } from "@/shared/ui/icon";

export default function ProjectColorsFixture() {
  return <div className="grid gap-3 p-4 sm:grid-cols-2">
    {PROJECT_COLORS.map((color) => <section className="pb-main-surface rounded-md border p-4" key={color.name} style={projectColorVariables(color) as CSSProperties}>
