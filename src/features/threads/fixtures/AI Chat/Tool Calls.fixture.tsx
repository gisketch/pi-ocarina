...
export default <div className="mx-auto grid max-w-3xl gap-3">
  ...
  <ToolCall defaultOpen onOpenFile={openFile} tool={{ role: "tool", toolName: "edit", status: "completed", input: { path: "src/styles.css", edits: [{ oldText: "color: gray;\npadding: 4px;", newText: "color: white;\npadding: 8px;\ngap: 4px;" }] } }} />
