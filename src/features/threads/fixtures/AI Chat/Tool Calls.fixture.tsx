...
export default <div className="mx-auto grid max-w-3xl gap-3">
  ...
  <ToolCall defaultOpen tool={{ role: "tool", toolName: "edit", status: "completed", input: { path: "src/styles.css", edits: [{ oldText: "color: gray;", newText: "color: white;" }] } }} />
  <ToolCall tool={{ role: "tool", toolName: "write", status: "completed", input: { path: "src/new-file.ts", content: "export const ready = true;" }, output: "Created file" }} />
