...
import { MessageSquarePlusIcon, PencilIcon, SendIcon, StopCircleIcon } from "lucide-react";
...
/** @typedef {{ threadId: string, sessionFile: string, title?: string, messages: Message[], schema?: { fileVersion?: number, runtimeVersion: number, newer: boolean } }} Thread */
