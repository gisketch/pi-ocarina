...
import folderFilled from "@/shared/assets/folder-filled.svg";
...
const icons = { archive, "arrow-down": arrowDown, "arrow-up": arrowUp, attachment, "book-open": bookOpen, check, "chevron-down": chevronDown, "chevron-right": chevronRight, circle, close, copy, cpu, expand, "file-diff": fileDiff, folder, "folder-filled": folderFilled, "folder-open": folderOpen, "git-branch": gitBranch, grip, "message-plus": messagePlus, mic, monitor, moon, dots: moreHorizontal, "panel-left": panelLeft, paperclip, pencil, pin, plus, refresh, robot, rotate, search, send, settings, stop, sun, terminal, trash, tree };
...
const named = (name: IconName) => function PixelIcon({ size = 16, className = "", ...props }: NamedIconProps) { return <Icon name={name} size={size} className={className} {...props} />; };
export const ArchiveIcon = named("archive");
export const ArrowDownIcon = named("arrow-down");
export const ArrowUpIcon = named("arrow-up");
export const BookOpenIcon = named("book-open");
...
export const CpuIcon = named("cpu");
export const FileDiffIcon = named("file-diff");
export const FolderFilledIcon = named("folder-filled");
...
export const RobotIcon = named("robot");
