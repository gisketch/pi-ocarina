...
import { connect, type StartOptions } from './connect'

export type { StartOptions } from './connect'
...
export async function startClient(
  ...
  const { child, connection, published, waiting } = await connect(spec, root, options)
