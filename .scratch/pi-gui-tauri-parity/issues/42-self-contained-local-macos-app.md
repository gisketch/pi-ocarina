...
- [x] Native picker, prompt/run, transcript reopen, dynamic extension, and PTY terminal pass in the packaged app.
- [x] Application relaunch preserves valid app state and Pi sessions; signing, notarization, DMG, Homebrew, and updater are absent.
