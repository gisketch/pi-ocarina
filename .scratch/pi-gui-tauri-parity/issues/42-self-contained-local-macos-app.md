...
- [ ] The app launches from Finder with a minimal Finder-style PATH and requires no system Node, Bun, or Pi.
- [ ] Real upstream Pi auth and resource locations work without copying secrets into the bundle.
